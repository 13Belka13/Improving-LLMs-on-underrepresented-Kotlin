...
- `src/`: Contains the source code for the project.
  ...
  - `collect_data.py`: Script for collecting data from code repositories.
  - `fine_tune_model.py`: Script for fine-tuning the model on the Kotlin dataset.
  - `evaluate_model.py`: Script for evaluating the model on the Kotlin and Python datasets.
...
### Lack of Patterns in Some Places:
...
The Colab notebook used for training and evaluating the model can be found at: 

[Kotlin Code Completion with Fine-Tuned Transformer Model](https://drive.google.com/file/d/1EF-eCJUGmpSWh9mE089o5taBQp2I9t6p/view?usp=sharing).
...
[phi-1-5-finetuned-kotlin](https://huggingface.co/13Belka13/phi-1-5-finetuned-kotlin).
